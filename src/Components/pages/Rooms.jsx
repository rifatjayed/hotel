    ...
    return (
        <div>
            <div className='px-32 text-center'>
                ...
                <p className='	text-lg	font-medium	'>This largest eco-resort in Bangladesh boasts of 493 splendid rooms and suites with breathtaking sea and hill views. Lavishly appointed our rooms offer the ultimate in comfort. Our elaborate suites are embellished with kitchenette, Jacuzzi, and Infinity Pool for those who command luxury.</p>
            </div>
